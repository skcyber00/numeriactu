<template>
  <div class="flex justify-end items-center gap-x-1.5">
    ...
    <div
      class="block h-3 border-e border-gray-300 mx-3 dark:border-neutral-600"
    ></div>
    ...
    <div class="hs-dropdown relative inline-flex">
      ...
      >
        <a
          class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-400 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:text-neutral-400 dark:hover:bg-neutral-900 dark:focus:ring-neutral-400"
          href="#"
        >
          <svg
            class="flex-shrink-0 size-4"
        ...
        <div
          class="border-t border-gray-600 my-2 dark:border-neutral-800"
        ></div>
        <a
          class="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-400 hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-gray-400 dark:text-neutral-400 dark:hover:bg-neutral-900 dark:focus:ring-neutral-400"
          href="#"
