<template>
  <!-- ========== FOOTER ========== -->
  <footer class="mt-auto bg-gray-800 w-full dark:bg-gray-800">
    <div
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
        <div class="col-span-full lg:col-span-1">
          <NuxtLink
            ...
            to="/"
            aria-label="Brand"
            ><img class="h-11 w-auto" src="~/assets/img/numeriactu.png" alt=""
          /></NuxtLink>
        </div>
        <!-- End Col -->

        <div class="col-span-1">
          <h4 class="font-semibold text-gray-100">Catégories</h4>

          <div class="mt-3 grid space-y-3">
            <p v-for="item in navigation">
              <NuxtLink
        ...
        <div class="col-span-1">
          <h4 class="font-semibold text-gray-100">Liens utiles</h4>
      ...
      >
        <div class="flex justify-between items-center">
          <p class="text-sm text-gray-400 dark:text-neutral-400">
            Copyright © 2024 NumeriActu. Tous droits réservés.
          </p>
        </div>
        <!-- End Col -->
...
<script setup>
const navigation = [
  { name: "ACTUALITÉS", href: "/category/news" },
  { name: "JEUX", href: "/category/games" },
  { name: "HIGH-TECH", href: "/category/high-tech" },
  { name: "BONS PLANS", href: "/category/bons-plans" },
];
</script>
